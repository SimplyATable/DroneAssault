...
public class FastRobot extends GameObject {
    ...
    public FastRobot() {
        super("FastRobot", 100, 100, "BlueEnemyRobot.png");
    ...
    public void collisionReaction(GameObject collidedWith) {
        ...
        if(collidedWith.getName().equals("Enemy") || (collidedWith.getName().equals("Boss")  || (collidedWith.getName().equals("Shooter") || (collidedWith.getName().equals("Gunner"))))) {
            PhysicsResolution.addContact(this, collidedWith);
            //setPosition(200, 200);
        } //kill();
