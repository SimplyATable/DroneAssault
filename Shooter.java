...
public class Shooter extends GameObject{
    ...
    public Shooter() {
        super("Shooter", 100, 100, "YellowRobot.png");
    ...
    public void collisionReaction(GameObject collidedWith) {
        ...
        if(collidedWith.getName().equals("Enemy") || (collidedWith.getName().equals("Boss")  || (collidedWith.getName().equals("FastRobot") || (collidedWith.getName().equals("Gunner") || (collidedWith.getName().equals("Wall")))))) {
            PhysicsResolution.addContact(this, collidedWith);
            //setPosition(200, 200);
        } //kill();
    ...
    {
        ObjectManager.addGameObject(new EnemyBullet(direction_, getPosition()));
    }
}