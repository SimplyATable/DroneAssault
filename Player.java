...
public class Player extends GameObject {
    ...
    public void update(float dt) {
        ...
        bar.setPosition(getPositionX(), getPositionY() + 55);
        timer -= dt;
        if (timer <= 0) {
    ...
    {
        if(collidedWith.getName().equals("Enemy") || (collidedWith.getName().equals("Boss")  || (collidedWith.getName().equals("FastRobot") || (collidedWith.getName().equals("GunnerBullet") || (collidedWith.getName().equals("Shooter") || (collidedWith.getName().equals("Gunner"))))))) {
            h--;
            bar = ObjectManager.getGameObjectByName("Health");
        ...
        if(collidedWith.getName().equals("EnemyBullet")) {
            h--;
            bar = ObjectManager.getGameObjectByName("Health");
            bar.setScaleX(0.01f*h);
            System.out.println("PLAYER HEALTH: " + h);
        ...
        if(collidedWith.getName().equals("Wall") || (collidedWith.getName().equals("Player2") || (collidedWith.getName().equals("Generator")))) {
            PhysicsResolution.addContact(this, collidedWith);
        }
        if(h <= 0) {
